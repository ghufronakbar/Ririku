...
- **Player priority:** YouTube and YouTube Music in Chrome come first, then Apple Music and Spotify desktop apps.
...
Follow the [developer documentation](docs/development/README.md) to build the app, connect Chrome, and run the verification commands. Read [architecture.md](docs/development/architecture.md) before changing the bridge, playback clock, or lyrics pipeline.
