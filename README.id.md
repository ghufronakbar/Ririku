...
> **Status:** prototipe awal (v0.3.1). Rilis pertama belum diterbitkan, jadi untuk saat ini Ririku perlu [di-build dari source](docs/development/README.md). Spotify desktop dapat diaktifkan di Setup (pengujian langsung masih diperlukan). Apple Music belum didukung.
...
Putar lagu di browser tersebut dan arahkan pointer ke notch.
