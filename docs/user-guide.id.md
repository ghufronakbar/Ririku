...
Unduh `Ririku.zip` dari [halaman Releases](https://github.com/lanstheprodigy/ririku/releases), lalu klik dua kali untuk mengekstraknya. Rilis pertama belum diterbitkan; sampai saat itu, Ririku hanya bisa [di-build dari source](development/README.md).
...
**YouTube berubah dan ada fitur yang berhenti bekerja.** Ririku membaca halaman YouTube yang dapat berubah sewaktu-waktu. Silakan [buat issue](https://github.com/lanstheprodigy/ririku/issues).
