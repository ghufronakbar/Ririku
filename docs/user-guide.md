...
Download `Ririku.zip` from the [Releases page](https://github.com/lanstheprodigy/ririku/releases) and double-click it to unzip. No release has been published yet; until then, Ririku can only be [built from source](development/README.md).
...
**YouTube changed and something stopped working.** Ririku reads the YouTube page, which can change without notice. Please [open an issue](https://github.com/lanstheprodigy/ririku/issues).
